...
public class ModConfig {
    ...
    // Recipe ingredients are datapack-driven — override data/chiseledenchants/recipe/chiseled_enchanter.json
    // with a world/server datapack to change them (keep the result's light-purple custom name for detection).
